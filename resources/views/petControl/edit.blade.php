    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <h3 align="center"><b>แก้ไขข้อมูล PetControl</b></h3>
          ...
          {{-- <div class="container"> --}}
            <div class="row">
              <div class="col-md-12"> <br />
                <form method="post" action="{{ action('PetController@update',$id) }}" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group">
                    <label>ชื่อ</label>
                    <input type="text" name="name" class="form-control" placeholder="ป้อนชื่อ" value="{{$user->name}}" />
                  </div>
