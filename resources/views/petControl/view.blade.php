    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 align="center"><b>PetControl</b></h3>
                ...
                <tbody>
                  @foreach($data as $row)
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="{{ action('PetController@edit',$row['id']) }}" class="btn btn-warning">
                        <span class="glyphicon glyphicon-edit"></span> Edit
                        </a>
                      </td>
                      <td class="text-center">
                        <form method="post" class="delete_form" action="{{ action('PetController@destroy',$row['id']) }}">
                        {{csrf_field()}}
